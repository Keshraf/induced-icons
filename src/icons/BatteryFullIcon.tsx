...
const BatteryFullIcon = (props: IconProps) => {
  return (
...
<path d="M9.88 10C10.21 11.31 10.21 12.69 9.88 14" stroke="#292D32" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
<path d="M13.38 10C13.71 11.31 13.71 12.69 13.38 14" stroke="#292D32" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
