...
const Logout1Icon = (props: IconProps) => {
  return (
...
<path d="M9.76001 12.0601H19.93" stroke="#292D32" strokeWidth="1.5" strokeMiterlimit="10" strokeLinecap="round" strokeLinejoin="round"/>
