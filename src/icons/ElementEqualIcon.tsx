...
const ElementEqualIcon = (props: IconProps) => {
  return (
...
<path d="M15 15.5H21" stroke="#292D32" strokeWidth="1.5" strokeLinecap="round"/>
<path d="M15 19.5H21" stroke="#292D32" strokeWidth="1.5" strokeLinecap="round"/>
</svg>
