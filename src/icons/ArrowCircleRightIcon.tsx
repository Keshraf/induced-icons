...
const ArrowCircleRightIcon = (props: IconProps) => {
  return (
...
<path d="M10.74 15.53L14.26 12L10.74 8.46997" stroke="#292D32" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
</svg>
