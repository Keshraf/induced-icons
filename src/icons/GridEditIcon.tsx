...
const GridEditIcon = (props: IconProps) => {
  return (
...
<path d="M18.14 15.26C18.49 16.52 19.48 17.5 20.74 17.86" stroke="#292D32" strokeWidth="1.5" strokeMiterlimit="10" strokeLinecap="round" strokeLinejoin="round"/>
</svg>
