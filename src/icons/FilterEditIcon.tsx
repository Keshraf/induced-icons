...
const FilterEditIcon = (props: IconProps) => {
  return (
...
<path d="M16.58 12.39C16.88 13.47 17.7199 14.31 18.7999 14.61" stroke="#292D32" strokeWidth="1.5" strokeMiterlimit="10" strokeLinecap="round" strokeLinejoin="round"/>
</svg>
