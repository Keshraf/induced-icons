...
const Eraser2Icon = (props: IconProps) => {
  return (
...
<path d="M7.12 9.12988L14.87 16.8799" stroke="#292D32" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
<path d="M3.52002 17.66L9.16998 12" stroke="#292D32" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
<path d="M6.34003 20.4901L12 14.8301" stroke="#292D32" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
</svg>

  );
};

export default Eraser2Icon;
