...
const GameboyIcon = (props: IconProps) => {
  return (
...
<path d="M8.03003 15.3101L10.33 17.61" stroke="#292D32" strokeWidth="1.5" strokeMiterlimit="10" strokeLinecap="round" strokeLinejoin="round"/>
<path d="M16.49 15.3301H16.51" stroke="#292D32" strokeWidth="2" strokeMiterlimit="10" strokeLinecap="round" strokeLinejoin="round"/>
