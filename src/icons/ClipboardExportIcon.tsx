...
const ClipboardExportIcon = (props: IconProps) => {
  return (
...
<path d="M15 19V16H18" stroke="#292D32" strokeWidth="1.5" strokeMiterlimit="10" strokeLinecap="round" strokeLinejoin="round"/>
<path d="M21 22L15.04 16.04" stroke="#292D32" strokeWidth="1.5" strokeMiterlimit="10" strokeLinecap="round" strokeLinejoin="round"/>
</svg>

  );
};

export default ClipboardExportIcon;
