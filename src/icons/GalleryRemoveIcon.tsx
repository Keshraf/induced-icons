...
const GalleryRemoveIcon = (props: IconProps) => {
  return (
...
<path d="M16.5601 6.94006L20.4401 3.06006" stroke="#292D32" strokeWidth="1.5" strokeLinecap="round"/>
<path d="M20.4401 6.94006L16.5601 3.06006" stroke="#292D32" strokeWidth="1.5" strokeLinecap="round"/>
