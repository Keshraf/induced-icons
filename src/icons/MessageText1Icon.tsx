...
const MessageText1Icon = (props: IconProps) => {
  return (
...
<path d="M7 8H17" stroke="#292D32" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
...
export default MessageText1Icon;
