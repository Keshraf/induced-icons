...
const BoxRemoveIcon = (props: IconProps) => {
  return (
...
<path d="M20.07 19.0399L17.95 16.9299" stroke="#292D32" strokeWidth="1.5" strokeMiterlimit="10" strokeLinecap="round" strokeLinejoin="round"/>
<path d="M20.05 16.96L17.93 19.0699" stroke="#292D32" strokeWidth="1.5" strokeMiterlimit="10" strokeLinecap="round" strokeLinejoin="round"/>
</svg>

  );
};

export default BoxRemoveIcon;
