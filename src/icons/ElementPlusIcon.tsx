...
const ElementPlusIcon = (props: IconProps) => {
  return (
    <svg {...props}   viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
<path d="M22 8.27V4.23C22 2.64 21.36 2 19.77 2H15.73C14.14 2 13.5 2.64 13.5 4.23V8.27C13.5 9.86 14.14 10.5 15.73 10.5H19.77C21.36 10.5 22 9.86 22 8.27Z" stroke="#292D32" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
...
<path d="M14.5 17.5H20.5" stroke="#292D32" strokeWidth="1.5" strokeLinecap="round"/>
<path d="M17.5 20.5V14.5" stroke="#292D32" strokeWidth="1.5" strokeLinecap="round"/>
</svg>
