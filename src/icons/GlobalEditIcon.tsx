...
const GlobalEditIcon = (props: IconProps) => {
  return (
...
<path d="M18.7 16.25C19 17.33 19.84 18.17 20.92 18.47" stroke="#292D32" strokeWidth="1.5" strokeMiterlimit="10" strokeLinecap="round" strokeLinejoin="round"/>
</svg>
