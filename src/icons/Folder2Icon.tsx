...
const Folder2Icon = (props: IconProps) => {
  return (
...
<path d="M8 2H17C19 2 20 3 20 5V6.38" stroke="#292D32" strokeWidth="1.5" strokeMiterlimit="10" strokeLinecap="round" strokeLinejoin="round"/>
</svg>
