...
const QuoteDownIcon = (props: IconProps) => {
  return (
...
<path d="M22 11.6499C22 17.6999 20.87 18.6998 17.47 20.7198" stroke="#292D32" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
...
<path d="M10.3701 11.6499C10.3701 17.6999 9.24009 18.6998 5.84009 20.7198" stroke="#292D32" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
</svg>
