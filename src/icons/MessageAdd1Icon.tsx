...
const MessageAdd1Icon = (props: IconProps) => {
  return (
...
<path d="M12 15.5V8.5" stroke="#292D32" strokeWidth="1.5" strokeMiterlimit="10" strokeLinecap="round" strokeLinejoin="round"/>
</svg>

  );
};

export default MessageAdd1Icon;
